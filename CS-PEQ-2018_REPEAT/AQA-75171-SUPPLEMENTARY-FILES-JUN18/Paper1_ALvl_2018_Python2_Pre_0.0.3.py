...
class QueueOfTiles():
  ...
  def Show(self):
    if self._Rear != -1:
      print
      sys.stdout.write("The contents of the queue are: ")
...
def DisplayTileValues(TileDictionary, AllowedWords):
  ...
  for Letter, Points in TileDictionary.items():
    sys.stdout.write("Points for " + Letter + ": " + str(Points) + "\n")
  print
...
def GetNewTileChoice():
  ...
  while NewTileChoice not in ["1", "2", "3", "4"]:
    ...
    NewTileChoice = raw_input(">")
  return NewTileChoice

def DisplayTilesInHand(PlayerTiles):
  print
  sys.stdout.write("Your current hand: " + PlayerTiles + "\n")
...
def HaveTurn(PlayerName, PlayerTiles, PlayerTilesPlayed, PlayerScore, TileDictionary, TileQueue, AllowedWords, MaxHandSize, NoOfEndOfTurnTiles):
  print
  sys.stdout.write(PlayerName + " it is your turn.\n")
  ...
  while not ValidChoice:
    ...
    if Choice == "1":
      ...
      print
      sys.stdout.write("Your word was: " + Choice + "\n")
      sys.stdout.write("Your new score is: " + str(PlayerScore) + "\n")
      sys.stdout.write("You have played " + str(PlayerTilesPlayed) + " tiles so far in this game.\n")
